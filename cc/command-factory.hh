...
class CommandFactory
{
 ...
 private:
    using FactoryFunc = std::shared_ptr<Command> (CommandFactory::*)(rjson::value&&, MongoAcmacsC2Access&, ClientConnection&, size_t) const;
    ...
    template <typename Cmd> std::shared_ptr<Command> make(rjson::value&& aSrc, MongoAcmacsC2Access& aMongoAccess, ClientConnection& aClientConnection, size_t aCommandNumber) const
        {
