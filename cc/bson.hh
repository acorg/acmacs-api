...
// ----------------------------------------------------------------------
    ...
    {
        in_for_optional_array_of_strings(append_to, key, mongo_operator, std::forward<Getter>(getter), [](const auto& value) -> std::string { return value.template to<std::string>(); });
    }
