...
ACMACS_API_SERVER_SOURCES = acmacs-api-server.cc mongo-access.cc session.cc command.cc command-factory.cc command-session.cc command-admin.cc command-chart.cc
